...
fn test_type_to_string() {
	...
	assert_eq!(Type::Integer { bits: 32 }.func_type(vec![ Type::Integer { bits: 32 }, Type::Integer { bits: 32 } ]).to_string(), "(i32, i32): i32")
}
...
use crate::{typ::Type, code::Function, Builder, value::BinaryIntrinsicFn};