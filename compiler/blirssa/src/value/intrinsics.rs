...
impl BinaryIntrinsicFn {
	pub fn output_type(&self) -> IntrinsicFnOutput {
		match self {
			Self::IntegerAdd | Self::IntegerSub |
			Self::IntegerMul | Self::IntegerDiv |
			Self::IntegerRem |
			Self::IntegerDivSig | Self::IntegerRemSig |
			Self::IntegerXor | Self::IntegerAnd |
			Self::IntegerOr |
			Self::IntegerShl | Self::IntegerShr |
			Self::IntegerShrSig |
			Self::FloatAdd | Self::FloatSub |
			Self::FloatMul | Self::FloatDiv |
			Self::FloatRem => IntrinsicFnOutput::Same,

			Self::IntegerCmpEq | Self::IntegerCmpNeq |
			Self::IntegerCmpLt | Self::IntegerCmpLte |
			Self::IntegerCmpGt | Self::IntegerCmpGte |
			Self::IntegerCmpLtSig | Self::IntegerCmpLteSig |
			Self::IntegerCmpGtSig | Self::IntegerCmpGteSig |
			Self::FloatCmpEq | Self::FloatCmpNeq |
			Self::FloatCmpLt | Self::FloatCmpLte |
			Self::FloatCmpGt | Self::FloatCmpGte => IntrinsicFnOutput::Boolean,
		}
	}
...
impl UnaryIntrinsicFn {
	pub fn output_type(&self) -> IntrinsicFnOutput {
		match self {
			...
			Self::IntegerTrunc32 => IntrinsicFnOutput::Integer(32),
			Self::IntegerExt16 | Self::IntegerExt16Sig |
			Self::IntegerTrunc16 => IntrinsicFnOutput::Integer(16),
